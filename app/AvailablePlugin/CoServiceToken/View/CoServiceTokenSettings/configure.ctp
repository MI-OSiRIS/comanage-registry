...
<table id="co_service_token_settings" class="ui-widget">
  <thead>
    <tr class="ui-widget-header">
      ...
      <th><?php print $this->Paginator->sort('CoServiceTokenSetting.co_provisioner_target_id', _txt('pl.coservicetoken.token.provisioner'));?></th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    <tr class="line<?php print ($i % 2)+1; ?>">
      ...
      <td>
        <?php
          // provisioner_id select for service tokens generated by external services
        
          $attrs = array();
          $attrs['empty'] = true;
          $attrs['value'] = (isset($c['CoServiceTokenSetting']['co_provisioner_target_id'])
                             ? $c['CoServiceTokenSetting']['co_provisioner_target_id']
                             : '');
          
          print $this->Form->select('CoServiceTokenSetting.' . $i . '.co_provisioner_target_id',
                                    $vv_ceph_provisioners,
                                    $attrs);

          if($this->Form->isFieldError('CoServiceTokenSetting.' . $i . '.co_provisioner_target_id')) {
            print $this->Form->error('CoServiceTokenSetting.' . $i . '.co_provisioner_target_id');
          }

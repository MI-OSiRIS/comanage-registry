...
$cm_co_service_token_texts['en_US'] = array(
  ...
  'en.coservicetoken.tokentype' => array(
    CoServiceTokenTypeEnum::Plain08 => 'Plain Text (8 character alphan/symbol)',
    CoServiceTokenTypeEnum::Plain15 => 'Plain Text (15 character alpha/symbol)',
    CoServiceTokenTypeEnum::Plain30 => 'Plain Text (30 character alpha/symbol)',
    CoServiceTokenTypeEnum::CephKey => 'Ceph Shared Secret Key (generated by cluster)',
    CoServiceTokenTypeEnum::CephRgwToken => 'Plain Text and RGW Encoded View (32 character alpha/symbol)'
  ),
  ...
  'pl.coservicetoken.token.success'      => 'Your token has been generated succesfully',
  'pl.coservicetoken.token.info'      => 'Your token has been generated. You can access it on the service tokens page.  If not automatically redirected back to the index page please click on the link above or in the Person menu at upper-right of the screen.',

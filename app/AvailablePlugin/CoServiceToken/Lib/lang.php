...
$cm_co_service_token_texts['en_US'] = array(
  ...
  'pl.coservicetoken.token.info'      => 'Your token has been generated. You can view it by returning to the service token page (this message is a lazy hack to be replaced by actually showing the token).',
